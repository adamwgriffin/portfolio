  ...
  return (
    <AnimatedSection className="prose">
      ...
      <p>
        ...
        primarily been Ruby on Rails, Postgres, React and Vue. My job has
        usually been as a full stack developer but I&apos;ve always had a strong
        interest in frontend development. I&apos;ve worked on several real
        estate (Proptech) SaaS apps over the years, such as listing search and a
        CRM.
      </p>
      <p>
        ...
        as a backend framework too. I use MongoDB a lot but I&apos;m also a big
        fan of Postgres. Occasionally I dabble in Go and the Gin web framework.
        I enjoy the emphasis on simplicity in the language but I have yet to
        truly become a &quot;Gopher.&quot; Maybe someday. You can check out{" "}

    ...
    <AnimatedSection className="prose">
      ...
      <article>
        ...
        <p>
          ...
          templates with some Stimulus sprinkled in, but I really missing
          working with components. It&apos;s hard to go back to templates and
          partials after having experienced the benefits of components. The
          authenticaion code generated by the new authentication generator is
          surpisingly useable, although I&apos;m not sure that I would trust it
          for a large scale application in production.
        </p>
